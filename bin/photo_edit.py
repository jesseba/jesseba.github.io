...
#
# Emptied on 2026-08-24: the site now shows every photograph that Flickr has,
# so there is nothing to deny. The mechanism is left in place because it is the
# only thing standing between a re-import and a future edit — put an id back in
# here and bin/apply-edit will drop that frame again. The edit it used to hold
# (146 Kyrgyzstan frames, 64 Utah) is recoverable from git history.
CUT = {
    "kyrgyzstan-2026": [],
    "utah-arizona-2021": [],
}
